...
public class RestAPIFilter implements Filter{
	 ...
	 private List<String> corsUrls = new ArrayList<>(Arrays.asList("http://localhost:5000", "http://127.0.0.1:5000", "http://0:0:0:0:0:0:0:1:5000","http://127.0.0.1:8080", "http://0:0:0:0:0:0:0:1:8080"));
